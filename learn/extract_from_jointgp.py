...
"""
extract trained *models* from a jointGP
"""
...
def main(sg_fname, target_phase="P", band="freq_0.8_4.5",
         run_name="kampos_init_phases", run_iter=1,
         holdout_eid=None):
...
if __name__=="__main__":
     main(sg_fname=sys.argv[1], run_name=sys.argv[2])
