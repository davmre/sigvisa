...
def main():
    ...
    parser.add_option("--no_duplicates", dest="no_duplicates", default=False, action="store_true", help="skip any wiggles which already have wiggle params of the same type")
