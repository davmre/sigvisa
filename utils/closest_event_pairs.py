...
for pair in p[:40]:
    print "evids %d, %d are at distance %.3fkm and have depths (%.3fkm, %.3fkm) (station dist %.2f)" % (pair[3], pair[4], pair[0], pair[1], pair[2], pair[5])
