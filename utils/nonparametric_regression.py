...
# kernel: a function taking a tuple of two d-dimensional vectors. Default
# is a Gaussian kernel with width chosen by Silverman's rule (avg distance
# of 3 nearest neighbors).
