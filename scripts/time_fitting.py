...
def main():
    ...
    for optim_method in ('bfgs',):
        t = time.time()
        fit_event_segment(event=event, sta='FITZ', tm=tm, output_run_name="fit_profiling", output_iteration=1, plot=False, wiggles=None, iid=True, extract_wiggles=False, method=optim_method)
