...
#        name='detail'),
    ...
    url(r'^wiggles/(?P<wiggleid>\d+)/$', wiggle_detail_view, name='wiggle_detail_view'),
    url(r'^wiggles/(?P<wiggleid>\d+)/raw_wiggle.png$', raw_wiggle_view, name='raw_wiggle'),
    url(r'^wiggles/(?P<wiggleid>\d+)/reconstructed_wiggle.png$', reconstructed_wiggle_view, name='reconstructed_wiggle'),
    url(r'^wiggles/(?P<wiggleid>\d+)/template_wiggle.png$', template_wiggle_view, name='template_wiggle'),
